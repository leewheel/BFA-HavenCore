...
enum AchievementFlags
{
    ...
    ACHIEVEMENT_FLAG_HALL_OF_FAME          = 0x00400000,    // with REALM_FIRST_KILL: first HallOfFameLimit guilds (per faction achievement)
};
...
enum CriteriaAdditionalCondition
{
    ...
    CRITERIA_ADDITIONAL_CONDITION_GUILD_GROUP_MEMBERS           = 80,
...
enum WorldStateExpressionFunctions
{
    ...
    WSE_FUNCTION_UNK25,
    WSE_FUNCTION_UNK26,
    WSE_FUNCTION_KEYSTONE_UPGRADES,     // 27: keystone upgrades earned by the run (>= 1 = completed in time)
