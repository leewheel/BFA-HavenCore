...
enum CharacterDatabaseStatements : uint32
{
    ...
    */
    ...
    CHAR_UPD_CLUB_MESSAGE_DESTROY,
    CHAR_DEL_CLUB_MESSAGES,
    CHAR_DEL_OLD_CLUB_MESSAGES,
    CHAR_DEL_EXPIRED_CLUB_MESSAGES,
    CHAR_DEL_EXPIRED_CLUB_MEMBER_MENTIONS,
    CHAR_REP_CLUB_STREAM_VIEW_MARKER,
    CHAR_DEL_CLUB_STREAM_VIEW_MARKER_MEMBER,
    CHAR_DEL_CLUB_STREAM_VIEW_MARKERS,
    CHAR_DEL_CLUB_MEMBER_MENTIONS,
    CHAR_SEL_GUILD_MEMBER_SKILLS,
    CHAR_SEL_GUILD_MEMBER_SKILLS_BY_GUID,
    CHAR_SEL_GUILD_MEMBER_SPELLS,
    CHAR_SEL_GUILD_MEMBER_SPELLS_BY_GUID,
    CHAR_SEL_GUILD_MEMBERS_WITH_SPELL,
